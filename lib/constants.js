...
export const FAULT_CAUSES = [
  ...
  { id: 'POR DETERMINAR', label: 'POR DETERMINAR', color: '#0288D1', textColor: '#ffffff' },
];
...
export function getCauseCategory(causaRaw) {
  ...
  if (clean.includes('POR DETERMINAR') || clean.includes('PENDIENTE') || clean.includes('INVESTIGACION') || clean.includes('POR EVALUAR')) {
    return FAULT_CAUSES[8]; // POR DETERMINAR
  }
